...
def create_feature_vectors(data, vocab):
    feature_vectors = []
    for text in data:
        words = text.split()
        vector = [0] * len(vocab)
...
with open('steam_reviews.csv', 'r') as csvfile:
    allreview = []
    ...
    # data = [row[review_index] for row in csvreader]
    # train_size = int(379914 * 0.8)
    ...
    x_train = create_feature_vectors(train_data, vocab)
    x_test = create_feature_vectors(test_data, vocab)
